 ...
 */
	...
	/**
	 * Take a temp node. 
	 * Traverse the node and compare with provide data till the last node.
	 * if provide data is matched then return true else navigate to the next node 
	 * if provide data is not found then return false.
	 * 
	 *
	 */
